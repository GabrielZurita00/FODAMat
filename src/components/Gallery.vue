<template>
  ...
  export default {
    ...
    methods: {
      ...
      nextImage() {
        if (this.currentImageIndex < this.selectedAlbum.images.length - 1) {
          this.currentImageIndex++;
        }
      }
    }
